...
<?php esc_html_e( 'Skip to content', 'newsup' ); ?></a>
	...
	<!-- CÉSAR Código para cargar widget de ticker criptomonedas en zona a través de fichero php (footer, header, etc) -->
			<?php if ( is_active_sidebar( 'criptomonedas' ) ) : ?>
				<div id="criptomonedas" class="primary-sidebar widget-area" role="complementary">
				<a href="/criptomonedas-precio-actual" </a>
					<?php dynamic_sidebar( 'criptomonedas' ); ?>
				</div><!-- #primary-sidebar -->
			<?php endif; ?>
	<!-- Fin de código carga widget ticker criptomonedas -->
...
<?php $show_popular_tags_title = newsup_get_option('show_popular_tags_title');
 ...
 do_action('newsup_action_front_page_main_section_1'); ?>
  <!-- CÉSAR Código para cargar widget en el espacio que deseemos -->
